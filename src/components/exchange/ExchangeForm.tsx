...
// Extracted the connection testing logic into its own function
async function testExchangeConnection(data: ExchangeFormValues): Promise<{success: boolean; message: string}> {
