      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 border-b border-[#333333] flex items-center justify-between px-6">
          <div className="flex items-center space-x-6">
            <a href="#" className="text-[#999999] hover:text-white transition-colors">Dashboard</a>
            <a href="#" className="text-[#999999] hover:text-white transition-colors">Terminal</a>
            <a href="#" className="text-white font-medium border-b-2 border-[#6a0dad] pb-1">Bots</a>
          ...
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-[#999999] max-w-4xl">
              ...
              <div className="flex items-center gap-3">
                <div className="relative w-full max-w-md">
                  ...
                  <Input 
                    className="pl-10 bg-[#222222] border-[#333333] text-white" 
                ...
                <Button 
                  className="whitespace-nowrap gap-2 bg-[#00e676] hover:bg-[#00c853] text-black" 
            ...
            <Tabs defaultValue="all" className="w-full">
              <TabsList className="mb-8 bg-transparent border-b border-[#333333] w-full justify-start h-auto">
                <TabsTrigger 
                  value="all" 
                  className="border-b-2 border-transparent data-[state=active]:border-[#6a0dad] data-[state=active]:bg-transparent rounded-none px-4 py-2 text-sm font-medium data-[state=active]:text-white data-[state=active]:shadow-none text-[#999999]"
                >
                  ALL BOTS
                </TabsTrigger>
                <TabsTrigger 
              ...
              <TabsContent value="all" className="space-y-10">
                <div className="space-y-8">
                  <div className="space-y-4">
                    <h2 className="text-lg font-semibold text-[#b388ff] flex items-center gap-2">
                      <div className="h-1 w-1 rounded-full bg-[#b388ff]"></div>
                      POPULAR STRATEGIES
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                      {popularStrategies.map((bot) => (
                        <div key={bot.id} className="bg-[#222222] border border-[#333333] rounded-lg overflow-hidden">
                          <div className="p-4 space-y-3">
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  {bot.isPopular && (
                                    <div className="bg-[#FF9800]/20 text-[#FF9800] text-xs px-2 py-0.5 rounded-sm inline-block">
                                      POPULAR
                                    </div>
                                  )}
                                  {bot.isNew && (
                                    <div className="bg-[#4CAF50]/20 text-[#4CAF50] text-xs px-2 py-0.5 rounded-sm inline-block">
                                      NEW
                                    </div>
                                  )}
                                </div>
                            ...
                            <p className="text-sm text-[#999999]">{bot.description}</p>
                          ...
                          <div className="p-3 border-t border-[#333333] flex items-center justify-center">
                            <Button
                              variant="ghost"
                              size="sm"
                              className="w-full text-xs gap-1 hover:bg-[#333333] hover:text-white text-[#b388ff]"
                            >
              ...
              {/* Add similar TabsContent sections for the other tabs */}
            </Tabs>
          </div>
        </div>
