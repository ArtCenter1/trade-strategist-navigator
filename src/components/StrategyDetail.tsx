...
const getStrategyDetails = (id: string) => {
  const strategies = {
    "rsi": {
      ...
      description: "RSI measures the magnitude of recent price changes to evaluate overbought or oversold conditions. It is displayed as an oscillator and can have a reading from 0 to 100.",
  ...
  return strategies[id as keyof typeof strategies];
};
